        ...
        $.getJSON(url, function (result) {
            ...
            $.each(result, function (i, field) {
                if (i == "totalsForAllResults") {
                    ...
                    $('#overview-total-desc').html(selectionTitle);
        ...
        $.getJSON(url, function (result) {
            ...
            $.each(result, function (i, field) {
                if (i == "totalsForAllResults") {
                    ...
                    $('#overview-total-desc').html("Average "+$('#filter').find(":selected").text()+":");
                    $('#overview').html(ctr);
