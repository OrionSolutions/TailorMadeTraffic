...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="full-width">
               ...
               <div class="content">
                ...
                <div class="status">
                    <h5>Redirecting...</h5>
                    <h6><span> <a href="https://tailormadetraffic.com/dashboard/dashboard.php">If the redirection doesn't work, please click here.</a></span></h6>
        ...
        <script type="text/javascript">
            setTimeout(function(){ 
                window.location.replace('https://tailormadetraffic.com/dashboard/dashboard.php');
                }, 3000);
        </script>
