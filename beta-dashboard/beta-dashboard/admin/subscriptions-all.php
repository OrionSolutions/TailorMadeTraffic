        ...
        <div class="container">
            <div class="full-width">
                <ul>
                    ...
                    <li class="current"><a href="#">Subscriptions</a></li>
        ...
        <div class="full-width">
            <div class="body-content">
                <div class="admin-title">
                    ...
                    <div class="one-sixth last"><h1>Website</h1></div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="admin-items">
                    ...
                    <div class="one-sixth last"><h1><?php echo $subscription["websitelink"];?></h1></div>
                    <div class="clear"></div>
                </div>
