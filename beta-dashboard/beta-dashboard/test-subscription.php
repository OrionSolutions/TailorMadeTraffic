...
try{
    ...
    $sqlsubscription = "SELECT * FROM `tblsubscription`,`tblsubscriptiontype` WHERE AccountID = '".$accid."' AND `tblsubscription`.`SubscriptionTypeID` = `tblsubscriptiontype`.`SubscriptionTypeID`";
    $idCheck = "SELECT * FROM `tblsubscription`,`tblsubscriptiontype` WHERE AccountID = '".$accid."' AND `tblsubscription`.`SubscriptionTypeID` = `tblsubscriptiontype`.`SubscriptionTypeID`";
        ...
        ?>
                    <div class="subscriptions">
                        <div class="s-items">
                            ...
                            <div class="one-fourth items">
                                <h3><i class="fa fa-gbp"></i> <?php echo $subscription_amount ?></h3>
                            </div>
                            <div class="one-fourth items">
    ...
    <div class="container">
        <div class="full-width">
            <div class="account-status">
                ...
                <div class="button">
                    <a href="https://tailormadetraffic.com/dashboard/subscribe-test.php" class="new-subscribe">New Subscription <i class="fa fa-plus"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
        ...
        <div class="sub-content">
            <div class="sub-center-left">
                ...
                <div class="sub-column">
                    <h2>Start Date: <span><?php echo $rsdata["StartDate"];?></span></h2>
                </div>
