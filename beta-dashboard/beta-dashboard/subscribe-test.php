  ...
  <script>
      firebase.auth().onAuthStateChanged(function(user) {
            ...
            localStorage["session_token"]= idToken;
                ...
                window.location.replace('subscription-login.php');
            }
            ...
            <div class="form-container-register">
                ...
                <!-- Left -->
                  <label><span><i class="fa fa-chevron-down"></i></span>
                    <select name="premiumselection" class="selectbox" id="premiumselection">
                        <option value="1">Basic Advertising</option>
                        <option value="2">Advance Advertising</option>
                        <option value="3">Package Advertising</option>
                        <option value="4">Custom Budget</option>
                    </select>
                ...
                <div class="one-half first">
                   ...
                   <label><span><i class="fa fa-money"></i></span>
                        <input type="number" class="textbox disabled" id="subamount" name="subamount" value="<?php echo $Pricing; ?>" placeholder="Subscription Amount" readonly>
                    </label> 
