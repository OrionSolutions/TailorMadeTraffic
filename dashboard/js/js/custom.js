$(document).ready(function () {
	...
	var siteID = "ga%3A137244157";
	var sDate = '2017-09-01';
	var eDate = '2017-09-30';
	var metrics = "ga%3Asessions%2Cga%3AbounceRate%2Cga%3AsessionDuration%2Cga%3AadClicks%2Cga%3ACTR";
	...
	siteID = "ga%3A137244157";
	sDate = '30daysAgo';
	eDate = 'yesterday';
	metrics = "ga%3Asessions%2Cga%3AbounceRate%2Cga%3AsessionDuration%2Cga%3AadClicks%2Cga%3ACTR";
	...
	$.getJSON(url, function (result) {
		...
		$.each(result, function (i, field) {
			if (i == "totalsForAllResults") {
				...
				var sessionDuration =data["ga:sessionDuration"];
				...
				$("#session-duration-monthly").append(sessionDuration);
				}
		});
	});
	...
	$.getJSON(url, function (result) {
		...
		$.each(result, function (i, field) {
			if (i == "totalsForAllResults") {
				...
				$("#session-duration-weekly").append(sessionDuration);
				}
		});
	});
	...
	$.getJSON(url, function (result) {
		...
		$.each(result, function (i, field) {
			if (i == "totalsForAllResults") {
				...
				$("#session-duration-daily").append(sessionDuration);
